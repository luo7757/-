  ...
  <view>
    ...
    <view class="list-card" v-if="item.mode==='base'" @click="goArticleDetail">
      <view class="list-card-img">
        <image :src="item.cover[0] ?item.cover[0] : '/static/img/1.jpg'"></image>
      </view>
...
export default {
	...
	methods:{
      ...
      const { _id, title, create_time, browse_count, thumbs_up_count, author } = this.item;
			const params = { _id, title, create_time, browse_count, thumbs_up_count, author };
